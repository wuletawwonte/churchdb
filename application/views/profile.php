    ...
    <section class="content">
        ...
        <?php if($this->session->flashdata('success')) { ?>
            <div class="callout callout-info">
                <?php echo $this->session->flashdata('success')." ልብ ይበሉ: ለውጦቹን ለማየት ወጥተው መግባት ይኖርቦታል።"; ?>
            </div>
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile" align="center">
                            <a href="<?= base_url('admin/profile'); ?>">
                                ...
                                <?php } else { ?>
                                    <div style="margin: 0 auto;height: 130px; width: 130px;margin-top: 15px;">
                                        <img class="img-circle" id="profilePicture" style="border: 3px solid #3c8dbc;padding: 3px;height: 130px; width: 130px;" src="<?= base_url(); ?>assets/profile_pictures/<?= $current_user['profile_picture']; ?>">
                                    </div>
                                <?php } ?>
                            </a><br>
                            ...
                            <a href="<?= base_url('admin/profile'); ?>"><h3 class="profile-username text-center">
                             ...
                             <div class="input-group input-group-lg">
                                <input type="file" form="UserEditor" accept="image/*"  class="form-control" id="avatarInput" name="profile_picture_input" onchange="document.getElementById('profilePicture').src = window.URL.createObjectURL(this.files[0]);" style="display: none;">
                                    ...
                                    <button type="button" class="btn btn-lg btn-info btn-flat" onclick="document.getElementById('avatarInput').value = ''; document.getElementById('profilePicture').src = '<?= base_url(); ?>assets/<?php if($current_user['profile_picture'] == NULL) { echo 'img/user-icon.jpg'; } else { echo 'profile_pictures/'.$current_user['profile_picture']; } ?>'"  style="border-radius: 0px;"><i class="fa fa-refresh"></i></button>
                            </div>
                        ...
                        <form class="form-horizontal" method="post" action="<?= base_url('admin/saveprofilechange') ?>" enctype="multipart/form-data" id="UserEditor">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" value="<?= $current_user['firstname']; ?>" class="form-control" name="firstname" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="lastname" class="col-sm-3 control-label"> የአባት ስም </label>
                                    <div class="col-sm-9">
                                        <input type="text" value="<?= $current_user['lastname']; ?>" class="form-control" name="lastname" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="username" class="col-sm-3 control-label"> የሲስተም መግቢያ ስም </label>
                                    <div class="col-sm-9">
                                        <input type="text" value="<?= $current_user['username']; ?>" class="form-control" name="username" required>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form class="form-horizontal" method="post" action="<?= base_url('admin/savepasswordchange') ?>">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" min=6 class="form-control" name="new_password" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" min=6 class="form-control" name="confirm_password" required>
                                    </div>
                                </div>                            
                            </div>
                            <div class="box-footer">
