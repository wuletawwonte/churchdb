                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile" align="center">
                            <a href="<?= base_url('admin/profile'); ?>">
                                ...
                                <?php } else { ?>
                                    <div style="margin: 0 auto;height: 130px; width: 130px;margin-top: 15px;">
                                        <img class="img-circle" id="profilePicture" style="border: 3px solid #3c8dbc;padding: 3px;height: 130px; width: 130px;" src="<?= base_url(); ?>assets/profile_pictures/<?= esc($pp); ?>">
                                    </div>
                                <?php } ?>
                            </a><br>
                            ...
                            <a href="<?= base_url('admin/profile'); ?>"><h3 class="profile-username text-center">
                             ...
                             <div class="input-group input-group-lg">
                                <input type="file" form="UserEditor" accept="image/*"  class="form-control" id="avatarInput" name="profile_picture_input" onchange="document.getElementById('profilePicture').src = window.URL.createObjectURL(this.files[0]);" style="display: none;">
                                    ...
                                    <button type="button" class="btn btn-lg btn-info btn-flat" onclick="document.getElementById('avatarInput').value = ''; document.getElementById('profilePicture').src = '<?= base_url(); ?>assets/<?php if($pp === null || $pp === '') { echo 'img/user-icon.jpg'; } else { echo 'profile_pictures/'.$pp; } ?>'"  style="border-radius: 0px;"><i class="fa fa-refresh"></i></button>
                            </div>
