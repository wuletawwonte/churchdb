...
<div class="mb-6">
  <h1 class="text-2xl font-bold">
    ክፍለ ከተማ
    <span class="mt-1 block text-base font-normal opacity-70">ክፍለ ከተማ የሚሞላው ፎርም ውስጥ ያሉ አማራጮች</span>
  </h1>
      ...
      <div class="modal-box max-w-lg">
        ...
        <form method="POST" action="<?= base_url('admin/editkifleketemachoice'); ?>" class="space-y-4">
          ...
          <div class="modal-action">
            <button type="button" class="btn" onclick="document.getElementById('editKifleKetema<?= $choice['kifle_ketema_id'] ?>').close()">ይቅር</button>
