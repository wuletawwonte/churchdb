...
<?= view('templates/partials/page_heading', [
    'title' => 'የምዕመን መረጃ ሪፖርት',
    'breadcrumbs_html' => '<ul><li><a href="' . esc(base_url(), 'url') . '" class="link link-hover"><i class="fa fa-dashboard"></i> ዳሽቦርድ </a></li><li class="text-base-content/80"> የምዕመን ሪፖርት </li></ul>',
]); ?>
