...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url(); ?>" class="logo">
      ...
      <span class="logo-mini"><?= session()->get('system_name_short'); ?></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><?= session()->get('system_name'); ?></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<?= base_url(); ?>assets/<?php $pp = $_SESSION['current_user']['profile_picture'] ?? null; if($pp === null || $pp === '') { echo 'img/user-icon.jpg'; } else { echo 'profile_pictures/'.$pp; } ?>" class="user-image" alt="User Image">
              <!-- hidden-xs hides the username on small devices so only the image appears. -->
              <span class="hidden-xs"><?php echo session()->get('current_user')['firstname'].' '.session()->get('current_user')['lastname']; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- The user image in the menu -->
              <li class="user-header">
                <img src="<?= base_url(); ?>assets/<?php $pp = $_SESSION['current_user']['profile_picture'] ?? null; if($pp === null || $pp === '') { echo 'img/user-icon.jpg'; } else { echo 'profile_pictures/'.$pp; } ?>" class="img-circle" alt="User Image">

                <p>
                  <?php echo session()->get('system_name'); ?>
                  <small><?= session()->get('current_user')['user_type']; ?></small>
                </p>
              </li>
              <!-- Menu Footer-->
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo session()->get('current_user')['firstname'].' '.session()->get('current_user')['lastname']; ?></p>
          <!-- Status -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?php if($active_menu == 'dashboard') { ?> class="active" <?php } ?>><a href="<?php echo base_url(); ?>"><i class="fa fa-dashboard"></i><span><?= lang('label.dashboard'); ?></span></a></li>
        <li <?php if($_SESSION['current_user']['user_type'] == 'መደበኛ ተጠቃሚ' && $_SESSION['current_user']['p_register_member'] != 'allow'){ echo 'hidden'; } if($active_menu == 'personregistration') { ?> class="active" <?php } ?> ><a href="<?php echo base_url(); ?>admin/personregistration"><i class="fa fa-user-plus"></i> <span><?= lang('label.add_new_person'); ?></span></a></li>
        <li <?php if($active_menu == 'listmembers') { ?> class="active" <?php } ?> ><a href="<?php echo base_url(); ?>admin/listmembers"><i class="fa fa-users"></i> <span><?= lang('label.members'); ?></span></a></li>      
        <li <?php if($_SESSION['current_user']['user_type'] == 'መደበኛ ተጠቃሚ' && $_SESSION['current_user']['p_manage_group'] != 'allow'){ echo 'hidden'; } if($active_menu == 'groups') { ?> class="active" <?php } ?>><a href="<?php echo base_url(); ?>admin/listgroups"><i class="fa fa-object-group"></i> <span><?= lang('label.groups'); ?></span></a></li>
